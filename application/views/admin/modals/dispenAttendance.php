<!-- Modal -->
<div class="modal fade" id="dispenModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-light" style="background-color:#063F8C;">
                <h5 class="modal-title" id="staticBackdropLabel"><b>Dispensasi</b></h5>
            ...
            <div class="modal-body" style="background-color: #e6e6e6;">
                <?php echo form_open_multipart('admin/pushDispen') ?>
