<!-- Modal -->
<div class="modal fade" id="sakitModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-light" style="background-color:#063F8C;">
                <h5 class="modal-title" id="staticBackdropLabel"><b>Sakit</b></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" style="background-color: #e6e6e6;">
                <?php echo form_open_multipart('admin/pushSakit') ?>
                <div class="container my-4">
                    ...
                    <br>
                    <label for="">Surat Sakit/Dokter: </label>
...
<script>
    $('#sakitModal').on('shown.bs.modal', function() {
        $('#sakitModal').trigger('focus')
    })
</script>